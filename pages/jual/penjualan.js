		...
		<Layout>
			<Container>
				<Row>
					<Col sm={8}>
						Transaksi
>>>>>>> 870c467e1af33dc894861a1dcc9c188b03879644
                    <h3>Penjualan</h3>
					</Col>
					<Col sm={4}>
						<div class="">
			...
			<table class="min-w-full table-auto">
				...
				<tbody class="bg-white divide-y divide-gray-200">
					...
					<tr>
						...
						<td class="px-2 py-2 whitespace-nowrap font-large">
							<div class="text-lg text-gray-900">TGL TRANSAKSI</div>
						</td>
						<td class="px-8 py-2 whitespace-nowrap font-large">
							<div class="text-lg text-gray-900">NO TRANSAKSI</div>
						</td>
						<td class="px-2 py-2 whitespace-nowrap font-large">
							<div class="text-lg text-gray-900">PELANGGAN</div>
						</td>
						<td class="px-2 py-2 whitespace-nowrap font-large">
							<div class="text-lg text-gray-900">TGL JATUH TEMPO</div>
						</td>
						<td class="px-2 py-2 whitespace-nowrap font-large">
							<div class="text-lg text-gray-900">XXX</div>
						</td>
